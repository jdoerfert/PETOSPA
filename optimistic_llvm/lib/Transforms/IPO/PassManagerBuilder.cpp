...
static cl::opt<bool> CheckForUnsoundAnnotationsLate(
    "check-unsound-annotation-opportunities-late", cl::init(false), cl::Hidden,
    cl::ZeroOrMore, cl::desc("TODO"));
...
void PassManagerBuilder::populateModulePassManager(
  ...
  createUnsoundPasses(EP_EarlyAsPossible, MPM);
  ...
  if (CheckForUnsoundAnnotationsLate)
    createUnsoundPasses(EP_EarlyAsPossible, MPM);
}
...
void PassManagerBuilder::addLTOOptimizationPasses(legacy::PassManagerBase &PM) {
  ...
  createUnsoundPasses(EP_EarlyAsPossible, PM);
